...
import {registerStudent,loginStudent,updateStudent,deleteStudent,getAllStudents,getStudentById,logoutStudent,aicomm  } from "../controllers/student.controller.js";
...
studentRouter.post("/studentaichat",authenticate,aicomm)
